...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MtlsSettings) DeepCopyInto(out *MtlsSettings) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MtlsSettings.
func (in *MtlsSettings) DeepCopy() *MtlsSettings {
	if in == nil {
		return nil
	}
	out := new(MtlsSettings)
	in.DeepCopyInto(out)
	return out
}
